...
import cr.una.bravo.bravofrontend.ui.ClientAdapter
...
class InsertClientFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<ImageButton>(R.id.btn_AddClient_Return).setOnClickListener { Navigation.findNavController(view).navigate(R.id.action_insertClientFragment_to_insertVehicle) }
