...
class InsertVehicle : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<ImageButton>(R.id.btn_AddVehicle_Return).setOnClickListener { Navigation.findNavController(view).navigate(R.id.action_insertVehicle_to_mainFragment) }
