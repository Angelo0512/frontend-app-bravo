...
class NewVehicleFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.btn_Vehicle_SubmitNew).setOnClickListener { Navigation.findNavController(view).navigate(R.id.action_insertVehicle_to_insertClientFragment) }
