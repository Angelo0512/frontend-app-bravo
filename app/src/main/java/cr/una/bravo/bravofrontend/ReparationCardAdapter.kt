...
fun filter(SearchText : String, spinnerFilter : String) {
 ...
 if(spinnerFilter == "Cliente")
  newList = reparationCardsOriginal.filter { it.clientId.replace("Cedula: ","") == SearchText } as MutableList<ReparationCard>
 if(spinnerFilter == "Placa")
  newList = reparationCardsOriginal.filter { it.vehiclePlate.replace("Placa Vehiculo: ","") == SearchText } as MutableList<ReparationCard>
